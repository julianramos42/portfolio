  ...
  return (
    <div className='habilidades' id='container-habilidades'>
      ...
      <Slider {...settings}>
        ...
        <div className='slide-component'>
          <i className="fa-brands fa-css3-alt fa-beat"></i>
          <h3>CSS3</h3>
        ...
        <div className='slide-component'>
          <i className="fa-brands fa-square-js fa-beat"></i>
          <h3>JavaScript</h3>
        ...
        <div className='slide-component'>
          <i className="fa-brands fa-node-js fa-beat"></i>
          <h3>NodeJs</h3>
        ...
        <div className='slide-component'>
          <i className="fa-brands fa-git-alt fa-beat"></i>
          <h3>Git</h3>
